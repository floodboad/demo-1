...
-- 导出 springboot-shardingjdbc1 的数据库结构
CREATE DATABASE IF NOT EXISTS `springboot-shardingjdbc1` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `springboot-shardingjdbc1`;


-- 导出  表 springboot-shardingjdbc1.alibaba 结构
...
-- 正在导出表  springboot-shardingjdbc1.alibaba 的数据：~0 rows (大约)
DELETE FROM `alibaba`;
...
-- 导出  表 springboot-shardingjdbc1.alibaba2 结构
...
-- 正在导出表  springboot-shardingjdbc1.alibaba2 的数据：~0 rows (大约)
